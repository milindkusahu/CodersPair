  ...
  return (
    <div className="container mx-auto px-4 py-10 max-w-4xl">
      ...
      <div className="space-y-6 text-base-content/90">
        <p>
          This privacy policy sets out how MILIND KUMAR SAHU uses and protects
          any information that you give MILIND KUMAR SAHU when you visit their
          website and/or agree to purchase from them.
        </p>

        <p>
          MILIND KUMAR SAHU is committed to ensuring that your privacy is
        ...
        <p>
          MILIND KUMAR SAHU may change this policy from time to time by updating
        ...
        <div>
          ...
          <p className="mt-3">
            ...
            incorrect or incomplete, please write to Raipur CHATTISGARH 495677
            or contact us at contact@milindsahu.com as soon as possible. We will
